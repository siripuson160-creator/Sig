...
# The unit every statistic is reported in. 0.01 is the MT4/MT5 point for a
# two-decimal gold quote, so "+70 Pips" ($7.00) reads as +700. Use 1.0 to
# count whole dollars instead.
POINT_SIZE={get('POINT_SIZE', '0.01')}
